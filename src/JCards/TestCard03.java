 ...
 * Obiettivo: testare BridgeHands, in particolare createRandomHand.
 */

public class TestCard03   {
        ...
        public static void main(String[] args)
                {
                 ...
                 while (true) {
                        MyIO.stampa("\r\n ========================================== ");
                        MyIO.stampa("Test03 Random hands per JCards package");
                        ...
                        MyIO.stampa(" 13: EX test Randomness file 1");
                        MyIO.stampa(" 14: EX test Randomness file 2");
                        MyIO.stampa(" 15: file XXX hands Random1");
                        MyIO.stampa(" 16: file XXX hands Random2");
                        MyIO.stampa(" 17: file XXX hands Random1 only stats");
                        MyIO.stampa(" 18: file XXX hands Random2 only stats");
                 ...
                 case 12:
                        ...
                        break;   
                 case 13:
                        theGame.runGame(4,getFileName());
                        break;   
                 case 14:
                        theGame.runGame(5,getFileName());
                        break;   
                 case 15:
                        theGame.runGame(6,getFileName());
                        break;   
                 case 16:
                        theGame.runGame(7,getFileName());
                        break;   
                 case 17:
                        theGame.runGame(8,getFileName());
                        break;   
                 case 18:
                        theGame.runGame(9,getFileName());
                        break;   
                        } 
                 }
             }
